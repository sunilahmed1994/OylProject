...
import { LocationDot, DownIcon, BackgroundBlack } from '../../../services/utilities/assets';
  ...
  return (
    <View>
      <ScrollView>
        ...
        <View>
          <CustomText style={[appStyles.marginleft, appStyles.textColorBlack, appStyles.marginTop1,{fontFamily: fontFamily.appTextBold}]}>Enter Time</CustomText>
        </View>
        <View style={appStyles.flexrow}>
          <View style={[appStyles.marginTop1]}>
            <CustomInput
              styleContainer={[appStyles.cardInputContainer, appStyles.flexrow, isHoursFocused ? { backgroundColor: '#FFFFC8' } : 'white',]}
          ...
          <View style={[appStyles.marginTop1]}>
            <CustomInput
              styleContainer={[appStyles.cardInputContainer, appStyles.flexrow, isMinutesFocused ? { backgroundColor: '#FFFFC8' } : 'white',]}
              styleInput={[ appStyles.cardInput,]}
              placeholder={'00'}
              value={minutes}
