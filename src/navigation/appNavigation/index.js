...
import { AccountBlack, HomeBlack } from '../../services/utilities/assets';
      ...
      <Tab.Screen name="HomeScreen" component={HomeScreen} 
        ...
        tabBarLabel:'Home',
         tabBarIcon:({color,size})=>(
           <Image source={HomeBlack.homeBlack} style={{ tintColor: 'black', width: responsiveWidth(6), height: responsiveHeight(3.5) }}/>
         )
        }}/>
