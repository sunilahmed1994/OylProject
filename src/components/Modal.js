...
import { LocationIcon,DownIcon,TickIcon,Payment } from '../services/utilities/assets/assets';
import { responsiveHeight, responsiveWidth } from 'react-native-responsive-dimensions';

const AccountModal = ({ isVisible, closeModal, navigation, option, tickImage, vehicleAdded = "", transparent, accountScreenActive, locationModal = false, oilModal = false, paymentModal = false, backdropOpacity = 0.7, oilOption }) => {
